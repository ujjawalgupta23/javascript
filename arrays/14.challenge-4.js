...
console.log(
    `Sarah's dog is eating ${
        dogSarah.curFood > dogSarah.recFood ? 'too much' : 'too low'
    }`
);
...
// 4.
const tooMuch = ownersEatTooMuch.join(' and ').concat("'s dog eat too much");
console.log(tooMuch);

const tooLittle = `${ownersEatTooLittle.join(' and ')}'s dog eat to little!'`;
...
shallowDogs.sort((a, b) => (a.recFood < b.recFood ? -1 : 1)); // or a.recFood - b.recFood
console.log(dogs);
